...
matched_fastas = glob.glob('sample?_part?_homologs.fasta')   # stores any fastas matched using the specified pattern
...
for fasta in matched_fastas:
    ...
    SeqIO.write(aa_sequences, f"sample{sample}_part{part}_translated.fasta", "fasta")
